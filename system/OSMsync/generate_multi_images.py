...
#--------------------------------------------------------------------------
''' This file generates cut out (specify size) images of the provided input images and '''
''' height image. Also connects to OSM database to collect osm-file that is rasterized and'''
