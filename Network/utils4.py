...
class Utils(object):
    ...
    def load_data(self):
    	...
    	training_data = self.configureData(training_osm, "../python features/graylevels/f35_g128_b4_gau4_train.npy", training=True)
    	test_data = self.configureData(test_osm, "../python features/graylevels/f35_g128_b4_gau4_test.npy")
